                                ...
                                @foreach ($bookedcars as $key => $bookedcars)
                                    <tr class="tr-{{ $bookedcars->id }}">
                                        ...
                                        <td>
                                            ...
                                            <a title="Details" href="{{ route('editallcars', $bookedcars->id) }}"
                                                class="btn btn-default waves-effect waves-float btn-sm waves-green"><i
                                                    class="zmdi zmdi-view-list-alt"></i></a>
                                            <button title="Accept" type="button" id="{{ $bookedcars->id }}"
                                                class="acceptbtn btn btn-default waves-effect waves-float btn-sm waves-red }}"><i
                                                    class="zmdi zmdi-check"></i></button>
                                            <button title="Reject" type="button" id="{{ $bookedcars->id }}"
