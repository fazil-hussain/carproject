...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Sale Cars</span></a>
                <ul class="ml-menu">
                    <li><a href="ec-dashboard.html">Dashboard</a></li>
                    <li><a href="{{ route('salevehical.create') }}">Add Car</a></li>
                    <li><a href="{{ route('salevehical.index') }}">All Cars</a></li>
                    <li><a href="{{ route('bookedcars') }}">Booked Cars</a></li>
                    <li><a href="{{ route('soldcaars') }}">Sold Cars</a></li>
                </ul>
            </li>
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Rent Cars</span></a>
                <ul class="ml-menu">
                    <li><a href="ec-dashboard.html">Dashboard</a></li>
                    <li><a href="{{ route('maketrip.index') }}">New_Booking</a></li>
                    <li><a href="{{ route('confirmrentbooking') }}">Confirm_Booking</a></li>
                    <li><a href="{{ route('rentcar.create') }}">Register Car</a></li>
                    <li><a href="{{ route('rentcar.index') }}">All Rental Cars</a></li>
                    <li><a href="ec-product-List.html">Rented Cars</a></li>
                    <li><a href="ec-product-detail.html">Availabel Cars</a></li>
                </ul>
            </li>
